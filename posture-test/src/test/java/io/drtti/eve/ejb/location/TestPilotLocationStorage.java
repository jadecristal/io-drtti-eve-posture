...
public class TestPilotLocationStorage {
    ...
    public void testPlsSetGetLocationDirect() {
        ...
        Assert.assertEquals(pls.getPilotLocation(pilot).getSolarSystem().getSolarSystemName(), CCP_EVE_SOLAR_SYSTEM_HUB);
    }
    ...
    public void testPlsSetAndChangeLocation() {
        ...
        Assert.assertEquals(pls.getPilotLocation(pilot).getSolarSystem().getSolarSystemName(), CCP_EVE_SOLAR_SYSTEM_HOME);
    }
